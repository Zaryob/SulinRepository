...
def install():
    ...
    #inarytools.remove("/usr/share/man/mann/sqlite3.n")

    # Expect package needs these symlinks
    inarytools.dosym("/usr/include/tcl-private/unix/tclUnixPort.h","/usr/include/tcl-private/generic/tclUnixPort.h")
    inarytools.dosym("/usr/include/tcl-private/unix/tclUnixThrd.h","/usr/include/tcl-private/generic/tclUnixThrd.h")
    ...
    inarytools.dosym("/usr/bin/tclsh8.6","/usr/bin/tclsh")
