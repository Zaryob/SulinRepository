...
def install():
    ...
    # Insall our theme
    inarytools.insinto("/usr/share/grub/themes/","themes/sulin")
    ...
    shelltools.copy("ascii.pf2","%s/usr/share/grub/themes/sulin" % get.installDIR())
    ...
    for font in fonts:
        shelltools.copy(font,"%s/usr/share/grub/themes/sulin" % get.installDIR())
